...
MIRROR_LOG = (
    int(MIRROR_LOG)
    if MIRROR_LOG.isdigit() or MIRROR_LOG.startswith("-")
    else MIRROR_LOG
)

OTHER_LOG = environ.get("OTHER_LOG", "")
OTHER_LOG = (
    int(OTHER_LOG) if OTHER_LOG.isdigit() or OTHER_LOG.startswith("-") else OTHER_LOG
)
...
CHANNEL_USERNAME = environ.get("CHANNEL_USERNAME", "Teamleech")
# ======================================================================


# ============================ STICKERS ================================
STICKERID_COUNT = environ.get(
    "STICKERID_COUNT",
    "CAACAgQAAxkBAAKE5GcY_waybDI9-OZqyB11EXYdoGrHAAKiGgACIPZSDMoAAcpM2WzqZDYE",
)
STICKERID_ERROR = environ.get(
    "STICKERID_ERROR",
    "CAACAgUAAxkBAAKE0mcY-4dK5n6f6g48N9Ewan6EwvqzAAKiBwACo5GpVIbD3xPwDzqSNgQ",
)
STICKERID_LEECH = environ.get(
    "STICKERID_LEECH",
    "CAACAgQAAxkBAAKE4WcY_ZUB7seTjXokfngVI1d-8rOnAAKxGgACIPZSDOnpobqbU-_dNgQ",
)
STICKERID_MIRROR = environ.get(
    "STICKERID_MIRROR",
    "CAACAgUAAxkBAAKE3mcY_RIiOQABU057pFcXzGirQawrNwACXQ8AAhNcSFbQs6XZtrORmzYE",
)
...
IMAGE_CANCEL = environ.get(
    "IMAGE_CANCEL",
    "https://graph.org/file/ba0a2e0fe939b05427a92-6bfb6342485bf0e53a.jpg",
)
IMAGE_CAPTION = environ.get(
    "IMAGE_CAPTION",
    "https://graph.org/file/2da667f5f93737fa5ee70-7db40690a107384a39.jpg",
)
IMAGE_COMMONS_CHECK = environ.get(
    "IMAGE_COMMONS_CHECK",
    "https://graph.org/file/518f52a70c871909fbff3-aabf1f8cb7901658fe.jpg",
)
IMAGE_COMPLETE = environ.get("IMAGE_COMPLETE", images)
IMAGE_CONEDIT = environ.get(
    "IMAGE_CONEDIT",
    "https://graph.org/file/54dcbd2bc0698c571e2d9-b590c6c0a96f575f29.jpg",
)
IMAGE_CONPRIVATE = environ.get(
    "IMAGE_CONPRIVATE",
    "https://graph.org/file/aced58062006da3dab2a6-f9a4fd26303a6c584d.jpg",
)
IMAGE_CONSET = environ.get(
    "IMAGE_CONSET",
    "https://graph.org/file/671bdaeef5dd5a948f8a6-0329ac606444dd6b55.jpg",
)
...
IMAGE_MEDINFO = environ.get(
    "IMAGE_MEDINFO",
    "https://graph.org/file/01d4c038e7ffafa2d7b01-ad60baee9fa8647c44.jpg",
)
...
IMAGE_RCLONE = environ.get(
    "IMAGE_RCLONE",
    "https://graph.org/file/6b6e4b9fd02e60bee148a-a091906157e2454f0f.jpg",
)
...
IMAGE_STATUS = environ.get(
    "IMAGE_STATUS",
    "https://graph.org/file/267a5d4ed16bd826cc0ad-28109866401cfeb6e0.jpg",
)
...
# ============================== UI ====================================
AUTHOR_NAME = environ.get("AUTHOR_NAME", "Teamleech")
...
GD_INFO = environ.get("GD_INFO", "By @Teamleech")
